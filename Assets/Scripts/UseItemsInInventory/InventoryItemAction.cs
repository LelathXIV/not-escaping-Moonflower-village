    ...
    private void UseObject()
    {
        ...
        switch (item.type)
        {
            case ItemType.weapon:
                var playerWeaponSlot = player.GetComponent<PlayerShootingSystem>();
                playerWeaponSlot.GetWeapon(item);
                GameObject.FindGameObjectWithTag("weaponSlot").GetComponentInChildren<Image>().sprite = item.prefabForInventory.GetComponent<Image>().sprite;
